...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Tyzo', url: 'https://tyzo.ru' }],
  publisher: 'Tyzo',
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://tyzo.ru/og-image.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://tyzo.ru/twitter-image.jpg'],
  },
  robots: {
    index: true,
    follow: true,
  ...
  return (
    <html lang="ru" className="h-full scroll-smooth">
      <head>
        ...
        <meta name="yandex-verification" content="71c03782a550a463" />
